...
<section class="courses">
    ...
    <h1 class="heading">Tutors courses</h1>

    <div class="box-container">
        <?php
            $courses_selected = $db->prepare("SELECT * FROM courses WHERE idTutor=? ORDER BY dateUp DESC");
            $courses_selected->execute([$tutor_id]);
        ...
        echo '<p class="empty_courses">no courses created yet by this tutor!</p>';}
        ?>
    </div>
